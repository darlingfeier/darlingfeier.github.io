...
Rain.prototype.splash = function() {
	if (!this.splashed) {
		...
		for (var i=0; i<16; 2="" 100="" i++)="" {="" var="" drop="drop_pool.pop()" ||="" new="" drop();="" drops.push(drop);="" drop.init(this.x);="" }="" droplet="" definition="" function="" drop()="" this.x="0;" this.y="0;" this.radius="Math.round(Math.random()" *="" +="" 1)="" demo.dpr;="" this.speed_x="0;" this.speed_y="0;" this.canvas="document.createElement('canvas');" this.ctx="this.canvas.getContext('2d');" render="" once="" and="" cache="" diameter="this.radius" 2;="" this.canvas.width="diameter;" this.canvas.height="diameter;" grd="this.ctx.createRadialGradient(this.radius," ,="" 1,="" this.radius,="" this.radius);="" grd.addcolorstop(0,="" demo.rain_color);="" grd.addcolorstop(1,="" demo.rain_color_clear);="" this.ctx.fillstyle="grd;" this.ctx.fillrect(0,="" 0,="" diameter,="" diameter);="" drop.max_speed="5;" drop.prototype.init="function(x)" angle="Math.random()" math.pi="" -="" (math.pi="" 0.5);="" speed="Math.random()" drop.max_speed;="" speed;="" drop.prototype.recycle="function()" demo.drop_pool.push(this);="" handle="" interaction="" demo.mousehandler="function(evt)" demo.updatecursor(evt.clientx,="" evt.clienty);="" demo.touchhandler="function(evt)" evt.preventdefault();="" touch="evt.touches[0];" demo.updatecursor(touch.clientx,="" touch.clienty);="" demo.updatecursor="function(x," y)="" x="" =="" demo.width;="" y="" demo.height;="" y_inverse="(1" y);="" demo.drop_delay="y_inverse*y_inverse*y_inverse" demo.wind="(x" 0.5)="" 50;="" document.addeventlistener('mousemove',="" demo.mousehandler);="" document.addeventlistener('touchstart',="" demo.touchhandler);="" document.addeventlistener('touchmove',="" frame="" ticker="" helper="" module="" public_api="{};" public="" will="" call="" reference="" repeatedly="" registered,="" passing="" elapsed="" time="" a="" lag="" multiplier="" as="" parameters="" public_api.addlistener="function" addlistener(fn)="" if="" (typeof="" fn="" !="=" 'function')="" throw('ticker.addlistener()="" requires="" passed="" in.');="" listeners.push(fn);="" start="" frame-loop="" lazily="" (!started)="" started="true;" queueframe();="" };="" private="" last_timestamp="0;" listeners="[];" queue="" up="" (calls="" framehandler)="" queueframe()="" (window.requestanimationframe)="" requestanimationframe(framehandler);="" else="" webkitrequestanimationframe(framehandler);="" framehandler(timestamp)="" frame_time="timestamp" last_timestamp;="" make="" sure="" negative="" isn't="" reported="" (first="" can="" be="" whacky)="" (frame_time="" <="" 0)="" cap="" minimum="" framerate="" to="" 15fps[~68ms]="" (assuming="" 60fps[~17ms]="" 'normal')=""> 68) {
			frame_time = 68;
		}
